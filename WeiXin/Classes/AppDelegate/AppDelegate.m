...
- (NSPersistentCloudKitContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentCloudKitContainer alloc] initWithName:@"WeiXin"];
...
- (void) setupNavBar{
    ...
    CGFloat rgb = 237;
    bar.barTintColor = [UIColor colorWithRed:rgb / 255 green:rgb / 255 blue:rgb / 255 alpha:1.0];
